...
public class UserController {
    ...
    public String saveUserSql(){
        String sql = "INSERT INTO USER (USER_NAME,USER_PASSWORD) VALUES ('AndyRon','123456')";
        int rows= jdbcTemplate.update(sql);

        return "执行成功，影响"+rows+"行";
    }

    // http://localhost:8080/saveUser?userName=tony3&passWord=t132345
    @GetMapping("saveUser")
    ...
    // 更新 http://localhost:8080/updateUserPassword?id=1&passWord=ar123456
    ...
    // http://localhost:8080/deleteUserById?id=4
    ...
    // 批量插入 http://localhost:8080/batchSaveUserSql

...
public class ApiVersionCondition implements RequestCondition<ApiVersionCondition> {
    ...
    public static final Pattern VERSION_PREFIX_PATTERN_1 = Pattern.compile("/v\\d\\.\\d\\.\\d/");
    public static final Pattern VERSION_PREFIX_PATTERN_2 = Pattern.compile("/v\\d\\.\\d/");
    public static final Pattern VERSION_PREFIX_PATTERN_3 = Pattern.compile("/v\\d/");
    public static final List<Pattern> VERSION_LIST = Collections.unmodifiableList(
